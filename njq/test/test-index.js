...
describe('node.js jq parser', function () {
  ...
  it('should return file not found stack trace if specify a wrong file as input', () => {
    testNodeJq(["-v", "-i", getResource('file-doesnot-exist.json'), ".name"], {
      rc: 1,
      // this error comes from node.js
      stderr: ['no such file or directory', 'test/resources/file-doesnot-exist.json', 'at Object.readFileSync'],
    });
  });
